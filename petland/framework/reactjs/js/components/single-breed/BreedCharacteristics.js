...
class BreedCharacteristics extends Component {
    ...
    render() {
        ...
        const {behavior} = breed;
        return (
            <div className="specs tab-pane fade" id="details" role="tabpanel" aria-labelledby="details-tab">
...
export default connect(mapStateToProps)(BreedCharacteristics);