...
class Redux_Core_Options
{
        ...
        $this->sections[] = [
            ...
            'fields' => [
                ...
                [
                    ...
                    'type' => 'select',
                    'data' => 'pages',
                    'title' => __('Terms and Conditions Page', $this->theme_locale),
                ],
                [
                    'id' => 'thank_you_page',
                    'type' => 'select',
                ...
                [
                    'id' => 'thank_you_employment_page',
                    'type' => 'select',
                    'data' => 'pages',
                    'title' => __('Thank You Employment Page', $this->theme_locale),
                ],
                [
                ...
                [
                    'id' => 'blog_mobile_bg',
                    'type' => 'media',
                    'title' => __('Blog Mobile Image', $this->theme_locale),
                ],
                [
    ...
    {
        $this->sections[] = [
            'title' => __('API Keys', $this->theme_locale),
            'desc' => __('API Keys', $this->theme_locale),
            'icon' => 'el el-cog',
            'fields' => [
                [
                    'id' => 'petkey_api_key',
                    'type' => 'multi_text',
                    'title' => 'API Keys',
                    'desc' => 'Use this format LOCATION_NAME|PET_KEY_API_KEY|SHOPWINDOW_ACCOUNT|SHOPWINDOW_FORM_ID'
                ],
                [
                    'id' => 'petkey_pet_types',
                    'type' => 'multi_text',
                ...
                [
                    ...
                    'type' => 'multi_text',
                    'title' => 'Pet Ages',
                    'desc' => 'Use this format 8|Up to 8 week or `8.1|Older than 8 week` adding the decimal if you want older than...'
                ],
                [
    ...
    private function add_footer_options()
    {
        $this->sections[] = [
            ...
            'fields' => [
                [
                    'id' => 'canine_certificated',
                    'type' => 'textarea',
                    'title' => 'Canine care certified description'
                ],
                [
                    'id' => 'footer_location',
                    'type' => 'multi_text',
                    'title' => 'Locations',
                    'desc' => 'Use this format LOCATION_NAME|LOCATION_ADDRESS|LOCATION_PHONE|LOCATION_DAYS|LOCATION_HOURS|FACEBOOK|PINTEREST|INSTAGRAM|YOUTUBE|TWITTER|PERMIT_NUMBER'
                ]
            ]
        ];
    }
    ...
    private function add_newsletter_options()
    {
        $this->sections[] = [
            'title' => __('Newsletter', $this->theme_locale),
            'desc' => __('', $this->theme_locale),
            'icon' => 'el el-cog',
            'fields' => [
                [
                    'id' => 'newsletter_small_title',
                    'type' => 'text',
                    'title' => 'Small title',
                ],
                [
                ...
                [
                    ...
                    'type' => 'media',
                    'title' => __('newsletter background Image', $this->theme_locale),
                ],
                [
                    'id' => 'newsletter_bg_mobile_image',
                    'type' => 'media',
                    'title' => __('newsletter background Image on mobile', $this->theme_locale),
                ],
                [
                    'id' => 'newsletter_token',
                    'type' => 'text',
                ...
                [
                    'id' => 'newsletter_list_memberships',
                    'type' => 'multi_text',
                    'title' => 'ID list of the memberships'
                ]
            ]
        ];
    }
