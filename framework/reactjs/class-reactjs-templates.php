...
class ReactJs_Templates {
	...
	public function enqueue_scripts() {
		...
		$script_vars = [
            ...
            'privacy_policy_page_url' => Theme_Manager::get_instance()->get_theme_page_link('privacy_policy_page'),
			'thank_you_app_page_url' => Theme_Manager::get_instance()->get_theme_page_link('thank_you_app_page'),
            'footer_locations' => Theme_Manager::get_instance()->get_footer_locations(),
            'form_blurb_message' => Theme_Manager::get_instance()->get_theme_option('form_blurb_message'),
	...
	private function get_pet_types() {
		...
		$types = [];
        if (is_array($pet_types) || is_object($pet_types)) {
	...
	private function get_pet_genders() {
        ...
        if (is_array($pet_genders) || is_object($pet_genders)) {
